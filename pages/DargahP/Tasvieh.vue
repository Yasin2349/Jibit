<template>
  <div class="w-full h-[700px] bg-cover bg-no-repeat bg-bottom py-20 flex justify-center items-center relative" 
    ...
    <div class="w-3/5 h-full flex justify-center items-center">
      <img src="https://jibit.ir/wp-content/themes/jibit/images/transferor/main-photo.svg" alt="image not found!" class="w-[520px] h-[480px] mt-10 z-1 object-cover" />
    </div>
    <div class="w-2/5 h-full flex flex-col justify-start text-right">
      <div class="divdis mt-[50px]">
...
درگاه پرداخت اینترنتی جیبیت
  ...
  <div class="w-full h-[260px] mt-[110px]">
    <ul class="h-full flex justify-center items-center mx-auto">
      <li class="w-[280px] rounded-[15px] h-[96%] bg-white list-none mx-2.5 direction-rtl shadow-[0_3px_2px_rgb(161,161,161)]">
        <div
          class="w-[55px] h-[55px] mt-[30px] mr-[30px] bg-center bg-cover"
          style="background-image: url('https://jibit.ir/wp-content/themes/jibit/images/transferor/feat4.svg')"
        ></div>
      ...
      <li class="w-[280px] rounded-[15px] h-[96%] bg-white list-none mx-2.5 direction-rtl shadow-[0_3px_2px_rgb(161,161,161)]">
        <div
          class="w-[55px] h-[55px] mt-[30px] mr-[30px] bg-center bg-cover"
          style="background-image: url('https://jibit.ir/wp-content/themes/jibit/images/transferor/feat3.svg')"
        ></div>
      ...
      <li class="w-[280px] rounded-[15px] h-[96%] bg-white list-none mx-2.5 direction-rtl shadow-[0_3px_2px_rgb(161,161,161)]">
        <div
          class="w-[55px] h-[55px] mt-[30px] mr-[30px] bg-center bg-cover"
          style="background-image: url('https://jibit.ir/wp-content/themes/jibit/images/transferor/feat2.svg')"
        ></div>
      ...
      <li class="w-[280px] rounded-[15px] h-[96%] bg-white list-none mx-2.5 direction-rtl shadow-[0_3px_2px_rgb(161,161,161)]">
        <div
          class="w-[55px] h-[55px] mt-[30px] mr-[30px] bg-center bg-cover"
          style="background-image: url('https://jibit.ir/wp-content/themes/jibit/images/transferor/feat1.svg')"
        ></div>
        <p class="w-[90%] pr-[10%] text-right text-[20px] text-[#303c4f] font-vazir leading-[55px]">۹۹٪ نرخ موفقیت</p>
        <p class="w-[66%] text-right mr-[10%] font-vazir2 text-[15px] font-bold text-[#697281]">
          بازگشت خودکار تراکنش‌های ناموفق به بانک، در نتیجه ۹۹٪ تراکنش‌ها تنها در ۵ دقیقه موفق خواهند بود.
        </p>
      </li>
    </ul>
  </div>
  <div class="div-about2">
    <div class="image" style="background-image: url('https://jibit.ir/wp-content/themes/jibit/images/transferor/instant-transfer.svg');"></div>
    <div class="objects">
...
<br>
بانک‌های فعال:
بانک ملی، ملت، تجارت، صادرات، سپه، شهر، پارسیان، آینده، اقتصاد نوین، رسالت، سامان، کشاورزی، پاسارگاد، مسکن، گردشگری</p>
      </div>
      <div class="divdis2">
        <div class="logo-about2"></div> 
      </div>
    </div>
  </div>
  <div class="div-about2">
...
این بار صرفه‌جویی در منابع زیر ساخت بهتر از هر زمان دیگری جواب می‌دهد.</p>
    ...
    <div class="image2" style="background-image: url(https://jibit.ir/wp-content/themes/jibit/images/transferor/batch-transfer.svg);"></div>
  </div>
  <div class="div-about2" style="border-bottom: 1px solid #dcdfe4; padding-bottom: 80px;">
    <div class="image" style="background-image: url(https://jibit.ir/wp-content/themes/jibit/images/transferor/bank-payment.svg);"></div>
    <div class="objects">
...
<br></p>
  ...
  <div class="div-about3">
    <div class="about3-box1">
      <div class="imgbox1" style="background-image: url('https://jibit.ir/wp-content/themes/jibit/images/transferor/service-feature-3.svg');"></div>
      <p class="p-title-box1">اشتراک‌گذاری جزئیات تراکنش</p>
      <p class="text-box1">با استفاده از وب‌سرویس انتقال وجه برای هر تراکنش یا دسته‌ای از تراکنش‌ها اقدام به اشتراک‌گذاری لینک جزئیات به مدت ۶۰ دقیقه با شرکا و مشتریان خود کنند.</p>
    </div>
    ...
    <div class="about3-box3">
      ...
      <p class="p-title-box1">مانیتور لحظه‌ای وضعیت تراکنش‌ها</p>
      <p class="text-box1">ز زمان درخواست تا پایان عملیات امکان بررسی فرآیند انتقال وجه امکان‌پذیر است. این ویژگی ارائه پشتیبانی و تجربه بهتر برای مشتریان کسب و کار‌ها را فراهم می‌کند.</p>
    </div>
  </div>
  <div class="div-about3">
    <div class="about3-box1">
      <div class="divdis2">
        <div class="logo2-box3" style="background-image: url(https://jibit.ir/wp-content/themes/jibit/images/transferor/service-feat-icon3.svg)">
          <div class="logo2"></div>
        </div>
      </div>
      <p class="p-title-box1">افزایش امنیت در ارسال درخواست</p>
      <p class="text-box1">با معرفی IP‌های مشخص خود، پردازش درخواست‌های تقلبی از سایر مبدا‌ها لغو می‌گردد.</p>
    </div>
    <div class="about3-box2">
      <div class="divdis2">
        <div class="logo2-box2" style="background-image: url(https://jibit.ir/wp-content/themes/jibit/images/transferor/service-feat-icon2.svg);">
          <div class="logo2"></div>
        </div>
      </div>
      <p class="p-title-box1">تکرار تراکنش نا‌موفق</p>
      <p class="text-box1">تکرار تراکنش نا‌موفق با همان کد یکتا امکانی است تا فرآیند پیگیری در قسمت پشتیبانی و حسابرسی مالی آسان‌تر شود.</p>
    </div>
    <div class="about3-box3">
      <div class="divdis2">
        <div class="logo2-box1" style="background-image: url(https://jibit.ir/wp-content/themes/jibit/images/transferor/service-feat-icon1.svg);">
          <div class="logo2"></div>
        </div>
      </div>
      <p class="p-title-box1">قابلیت لغو تراکنش‌ها</p>
      <p class="text-box1">۶۰ دقیقه زمان برای ارسال تراکنش به بانک امکان لغو تراکنش قبل از انتقال وجه را فراهم کرده است.</p>
    </div>
  </div>

  <div class="div-about4">
    <div class="div-title-about4">
      <p class="title-about4">تعرفه استرداد وجه</p>
      <p class="text-about4">تعرفه اعلام شده به ازای هر درخواست موفق کسر می‌شود.</p>
    </div>
    <div class="table-about4" style="background: linear-gradient(270deg, #ff8b70 0, #ff3c4c 6.22%, #226ce9 47.07%);">
...
<style scoped>
.w-full{
    background-image: url('https://jibit.ir/wp-content/themes/jibit/images/projectx/pattern-right-desktop.svg');
...
.li_logo1 {
  background-image: url(https://jibit.ir/wp-content/themes/jibit/images/logos/gray/snapp.svg);
}
.li_logo1:hover {
  
  background-image: url(https://jibit.ir/wp-content/themes/jibit/images/logos/colorful/snapp.svg);
...
.li_logo3 {
  background-image: url(https://jibit.ir/wp-content/themes/jibit/images/logos/gray/nobitex.svg);
}
.li_logo3:hover {
  background-image: url(https://jibit.ir/wp-content/themes/jibit/images/logos/colorful/nobitex.svg);
  filter: brightness(1.2);
}
.li_logo4 {
  background-image: url(https://jibit.ir/wp-content/themes/jibit/images/logos/gray/eghamat24.svg);
}
.li_logo4:hover {
  background-image: url(https://jibit.ir/wp-content/themes/jibit/images/logos/colorful/eghamat24.svg);
  filter: brightness(1.2);
}
.li_logo5 {
  background-image: url(https://jibit.ir/wp-content/themes/jibit/images/logos/gray/bitpin.svg);
}
.li_logo5:hover {
  background-image: url(https://jibit.ir/wp-content/themes/jibit/images/logos/colorful/bitpin.svg);
  filter: brightness(1.2);
}
.li_logo6 {
  background-image: url(https://jibit.ir/wp-content/themes/jibit/images/logos/gray/modaberasia.svg);
}
.li_logo6:hover {
  background-image: url(https://jibit.ir/wp-content/themes/jibit/images/logos/colorful/modaberasia.svg);
  filter: brightness(1.2);
}
.div-about2{
  width: 79%;
...
.image{
  width: 50%;
  height: 100%;
  background-image: url('https://jibit.ir/wp-content/themes/jibit/images/projectx/photo-1.svg');
...
.logo-divimg2{
  ...
  border-radius: 25px;
  margin-top: 60px;
  background-image: url('https://jibit.ir/wp-content/themes/jibit/images/projectx/photo-1-logo.svg');
  background-position: center;
  background-size: cover;
  background-repeat: no-repeat;
}
...
.logo-about2{
  width: 260px;
  height: 45px;
  background-image: url('https://jibit.ir/wp-content/themes/jibit/images/transferor/banks.svg');
  background-position: center;
  background-repeat: no-repeat;
  background-size: cover;
  margin-top: 15px;
...
.imgbox1{
  ...
  border-radius: 15px;
  border: 1px solid rgb(209, 209, 209);
  background-image: url('https://jibit.ir/wp-content/themes/jibit/images/projectx/service-feature-3.svg');
}
.imgbox2{
  width: 100%;
  height: 55%;
  ...
  border-radius: 15px;
  border: 1px solid rgb(209, 209, 209);
  background-image: url('https://jibit.ir/wp-content/themes/jibit/images/projectx/service-feature-2.svg');
}
.imgbox3{
  width: 100%;
  height: 55%;
  ...
  border-radius: 15px;
  border: 1px solid rgb(209, 209, 209);
  background-image: url('https://jibit.ir/wp-content/themes/jibit/images/projectx/service-feature-1.svg');
}
.p-title-box1{
  width: 100%;
  font-size: 20px;
...
.logo2-box1{
  ...
  border-radius: 25px;
  margin-top: 60px;
  background-image: url('https://jibit.ir/wp-content/themes/jibit/images/projectx/service-feat-icon1.svg');
  background-position: center;
  background-size: cover;
  background-repeat: no-repeat;
}
.logo2-box2{
  ...
  border-radius: 25px;
  margin-top: 60px;
  background-image: url('https://jibit.ir/wp-content/themes/jibit/images/projectx/service-feat-icon2.svg');
  background-position: center;
  background-size: cover;
  background-repeat: no-repeat;
}
.logo2-box3{
  ...
  border-radius: 25px;
  margin-top: 60px;
  background-image: url('https://jibit.ir/wp-content/themes/jibit/images/projectx/service-feat-icon3.svg');
  background-position: center;
  background-size: cover;
  background-repeat: no-repeat;
}
...
.div-pizito2{
  width: 96%;
  height: 200px;
  background: linear-gradient(90deg, #fff 50%, #e5dcfa 100%);
...
.table-about4{
  width: 94%;
  height: 80px;
  background: linear-gradient(270deg, #74e2df -5.69%, #226ce9 64.82%);
  margin: auto;
  border-radius: 10px;
  margin-top: 20px;
}
...
.image2{
  width: 50%;
  height: 100%;
  background-image: url('https://jibit.ir/wp-content/themes/jibit/images/pip/photo-2.svg');
  background-color: #f2f5fb ;
  background-position: center;
  background-repeat: no-repeat;
  background-size: cover;
